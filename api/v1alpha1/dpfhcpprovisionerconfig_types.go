...
const (
	...
	// DefaultBlueFieldOCPRepo is the fallback BlueField image repository used when the Config CR does not exist.
	// TODO: This should be replaced with the official registry once we have one
	DefaultBlueFieldOCPRepo = "quay.io/eelgaev/rhcos-bfb"
	// DefaultEnableBlueFieldValidation is the fallback value used when the Config CR does not exist.
	DefaultEnableBlueFieldValidation = true
)
...
// Only one instance named "default" should exist.
