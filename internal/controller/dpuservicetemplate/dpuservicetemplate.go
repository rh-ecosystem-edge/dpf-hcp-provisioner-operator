...
// The aarch64 image is needed because hosted cluster workloads run on DPUs which use the
// aarch64 architecture, while the management cluster is expected to be x86.
