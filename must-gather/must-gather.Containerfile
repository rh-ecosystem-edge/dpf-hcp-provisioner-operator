...
LABEL com.redhat.component="must-gather-rhel10" \
      ...
      summary="DPU Kit for NVIDIA - Must Gather" \
      io.k8s.display-name="DPU Kit for NVIDIA - Must Gather" \
      description="DPU Kit for NVIDIA - Must Gather" \
      io.k8s.description="DPU Kit for NVIDIA - Must Gather" \
