...
const (
	...
	// ServiceReferenceInDPUDeployment contains the name of the service as found in the DPUDeployment. This label can
	// be found on Pods and other resources in the DPUCluster managed by the DPUServices the DPUDeployment generates as
	// long as the Helm Chart used in the DPUServiceTemplate follows the DPF contract. In addition it can be found on
	// resources generated by the DPUDeployment associated with the service (DPUService, DPUServiceInterface).
	ServiceReferenceInDPUDeploymentLabelKey = "svc.dpu.nvidia.com/dpudeployment-service"
