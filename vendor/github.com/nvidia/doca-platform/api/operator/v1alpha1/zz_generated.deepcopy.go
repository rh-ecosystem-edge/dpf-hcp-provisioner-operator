...
func (in *DPFOperatorConfigSpec) DeepCopyInto(out *DPFOperatorConfigSpec) {
	*out = *in
	...
	if in.KataContainers != nil {
		in, out := &in.KataContainers, &out.KataContainers
		*out = new(KataContainersConfiguration)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KataContainersConfiguration) DeepCopyInto(out *KataContainersConfiguration) {
	*out = *in
	in.BaseComponentConfig.DeepCopyInto(&out.BaseComponentConfig)
	in.HelmComponentConfig.DeepCopyInto(&out.HelmComponentConfig)
	if in.Daemon != nil {
	...
	if in.Shims != nil {
		in, out := &in.Shims, &out.Shims
		*out = make([]KataShim, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KataContainersConfiguration.
func (in *KataContainersConfiguration) DeepCopy() *KataContainersConfiguration {
	if in == nil {
		return nil
	}
	out := new(KataContainersConfiguration)
